...
impl <'a> ChipSystem <'a> {
    const DECODED_INSTRUCTIONS: [fn(&mut Self, u16) -> Result<(), String>; 16] = [
    ...
    pub fn load_program_from_vector(&mut self, program_array: Vec<u8>) {
	...
	return Self::DECODED_INSTRUCTIONS[get_instruction_category(combined_instruction)](self, combined_instruction);
    }
